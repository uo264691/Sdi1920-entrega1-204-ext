...
//		SeleniumUtils.esperarSegundos(driver, 2);
		...
		elementos = SeleniumUtils.EsperaCargaPagina(driver, "id", textLanguage, getTimeout()); elementos.get(0).click();
	}
	
	public static boolean isThisURL(WebDriver driver, String URL) {
